 ...
 *
 */
public final class CountyDetail {
    ...
    public CountyDetail(final County county, final Statistic latestStatistic, final List<Statistic> statisticsOfLastFourteenDays) {
