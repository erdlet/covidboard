...
public class DetailsPage {
    ...
    public DetailsPage(final CountyDetail details) {
    ...
    public static class CurrentDataCardContent {
        ...
        public CurrentDataCardContent(final Statistic statistic) {
            this.sevenDayIncidence = Formatters.formatDoubleToStringWithTwoDecimalPlaces(statistic.getSevenDayIncidence());
